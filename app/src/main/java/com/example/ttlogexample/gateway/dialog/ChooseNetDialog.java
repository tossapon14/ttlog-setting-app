package com.example.ttlogexample.gateway.dialog;
...
import com.example.ttlogexample.databinding.ItemScanWifiBinding;
    ...
    public class WiFiListAdapter extends RecyclerView.Adapter<WiFiListAdapter.WiFiViewHolder> {
        ...
        class WiFiViewHolder extends RecyclerView.ViewHolder {
            ...
            public WiFiViewHolder(View itemView) {
                super(itemView);
                itemBinding = ItemScanWifiBinding.bind(itemView);
            }

            public void Bind(WiFi wiFi) {
                if (wiFi != null) {
                    itemBinding.name.setText(wiFi.getSsid() != null ? wiFi.getSsid() : "");
                    itemBinding.signal.setText(String.valueOf(wiFi.getRssi()));

                    itemBinding.getRoot().setOnClickListener(v -> {
                        if (onSelectListener != null) {
                            onSelectListener.onSelect(wiFi);
                            cancel();
                        }
                    });
                }
