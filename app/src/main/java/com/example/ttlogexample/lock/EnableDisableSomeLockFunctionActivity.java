...
import com.example.ttlogexample.databinding.ActivityEnableDisableSomeLockFunctionBinding;
 ...
 */
public class EnableDisableSomeLockFunctionActivity extends BaseActivity {
    ActivityEnableDisableSomeLockFunctionBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityEnableDisableSomeLockFunctionBinding.inflate(getLayoutInflater());
