...
import com.example.ttlogexample.databinding.LockAddListItemBinding;
...
public class LockListAdapter extends RecyclerView.Adapter<LockListAdapter.DeviceViewHolder> {
    ...
    public void setOnLockItemClick(onLockItemClick click) {
        // this.mListener is interface and click is interface of class use
        // if you pass {setOnLockItemClick(this)} java manage choose only interface method pass to this click
    ...
    class DeviceViewHolder extends RecyclerView.ViewHolder {
        ...
        public DeviceViewHolder(View itemView) {
            super(itemView);
            itemBinding = LockAddListItemBinding.bind(itemView);
        }
...
//            itemBinding.ivSettingMode.setVisibility(View.VISIBLE);
